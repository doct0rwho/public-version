...
async function avgTimeSpent30Days(req, res) {
  try {
    const currentDate = new Date();
    const dailyData = [];
    const startDate = new Date(currentDate);
    startDate.setDate(startDate.getDate() - 29); // Start date for 30 days ago

    // Fetch total duration and user count for web sessions for each day within the last 30 days
    ...
    // Fetch total duration and user count for app sessions for each day within the last 30 days
...
module.exports.avgTimeSpent30Days = avgTimeSpent30Days;
