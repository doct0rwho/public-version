...
async function avgTimeSpent365Days(req, res) {
  try {
    const currentDate = new Date();
    const startDate = new Date(currentDate);
    startDate.setDate(startDate.getDate() - 364); // Start date for 365 days ago

    // Fetch total duration and user count for web sessions for each day within the last 365 days
    ...
    // Fetch total duration and user count for app sessions for each day within the last 365 days
...
module.exports.avgTimeSpent365Days = avgTimeSpent365Days;
