...
async function getAppAndWebSessionUserDduration365Days(req, res) {
  try {
    ...
    const results = await db.raw(
      ...
      FROM (
        ...
        WHERE timeStart >= :queryStartDate AND companyId = :company AND userId = :user
...
module.exports.getAppAndWebSessionUserDduration365Days =
  getAppAndWebSessionUserDduration365Days;
