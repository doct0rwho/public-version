...
async function getVideoSessionCount365Days(req, res) {
  try {
    ...
    const results = await db.raw(
      `
    SELECT timeStart AS date, COUNT(videoSessionId) AS count
    FROM (
        SELECT timeStart, videoSessionId
        FROM metaenga_video_session
...
module.exports.getVideoSessionCount365Days = getVideoSessionCount365Days;
