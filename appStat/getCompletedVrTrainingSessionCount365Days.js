...
async function getCompletedVrTrainingSessionCount365Days(req, res) {
  try {
    ...
    FROM (
        ...
        WHERE timeStart >= :queryStartDate AND companyId = :company AND status = 0
        ) AS all_sessions
...
module.exports.getCompletedVrTrainingSessionCount365Days =
  getCompletedVrTrainingSessionCount365Days;
