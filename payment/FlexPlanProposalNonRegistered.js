...
async function FlexPlanProposalNonRegistered(req, res) {
  const sendEmail = async () => {
    try {
      ...
      let pdflink = `${process.env.URL}/get/flex/plan/pdf`;
      let month = new Date();
      let formattedDate =
      ...
      const payload = {
        transactionalId: "clwomvlu700b9h0iay0jeh56g",
        email: email,
        dataVariables: {
          pdflink: pdflink,
          month: formattedDate,
...
module.exports.FlexPlanProposalNonRegistered = FlexPlanProposalNonRegistered;
